--[[--
Auto-rotate module for Double Tap plugin.
Rotates the screen automatically for landscape (double-spread) pages.
Pattern based on https://github.com/Extraltodeus/koreader-autorotate
@module holdzoom.autorotate
]]--
